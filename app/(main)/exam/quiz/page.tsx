...
function QuizContent() {
    ...
    const [questionCounts, setQuestionCounts] = useState(1);
    ...
    const handleNextQuestion = () => {
        setQuestionCounts(prev => prev + 1);
        if (questionCounts >= 10) {
            saveProgressAndExit();
        }
        else {
            fetchQuestion();
    ...
    const saveProgressAndExit = async () => {
        try {
            const response = await fetch("/api/exam/progress", {
                ...
                body: JSON.stringify({
                    exam_topic: topicsParam,
                    score: score.points,
                    pass: score.correct >= 7,
        ...
        router.push("/exam/results?score=" + score.points + "&total=10&topic=" + topicsParam + "&correct=" + score.correct + "&incorrect=" + score.incorrect + "&passed=" + (score.correct >= 7));
        ...
        <div className="flex flex-col items-center min-h-screen p-8">
          <div className="w-full max-w-4xl">
            <div className="flex justify-between items-center mb-8">
              <h1 className="text-2xl font-bold">Exam on {topicsParam}</h1>
            ...
            {loading ? (
              ...
              <div className="bg-white shadow-md rounded-lg p-6">
                ...
                <div className="flex justify-between">
                  ...
                  <Button variant="default" onClick={Exit} className='px-4 py-2'>
                    Exit Quiz
                  </Button>
                  {showExplanation && (
                    <button 
