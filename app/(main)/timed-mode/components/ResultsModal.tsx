...
const ResultsModal: React.FC<ResultsModalProps> = ({
  ...
  const questionsPerMinute = totalQuestions > 0 ? (totalQuestions / duration).toFixed(1) : 0;
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white text-center relative">
          ...
          <p className="mb-8">{duration} Minute Challenge</p>
        </div>
        ...
        <div className="pt-12 pb-4 px-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <StatCard 
              ...
              label="Questions/Min"
              value={questionsPerMinute.toString()}
            />
          </div>
